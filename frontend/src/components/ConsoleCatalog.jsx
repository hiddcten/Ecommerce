...
const ConsoleCatalog = () => {
  ...
  useEffect(() => {
    axios.get("http://localhost:5000/api/products/category?category=Console")
      ...
      .catch(error => {
        setError("Error fetching consoles. Please try again.");
      });
  }, []);
  ...
  const handleSort = (criteria) => {
    let sortedConsoles = [...consoles];
    switch (criteria) {
      case "price-low":
        sortedConsoles.sort((a, b) => a.price - b.price);
        break;
      case "price-high":
    ...
    <div className="min-h-screen bg-gray-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="pt-20 max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4 sm:mb-0">Console Catalog</h1>
